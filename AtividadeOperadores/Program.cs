// Atividade Operadores - Sintaxe Básica em C#

// Exercício 01 - Soma de 3 notas e mostre a média deles.
...
// Exercício 02 - Temperatura Leia uma temperatura em Celsius e converta para Fahrenheit usando a fórmula:
...
Console.WriteLine($"A temperatura em Fahrenehit é: {Fahrenheit}");


// Exercício 03 - Área de Quadrado: Leia o lado de um quadrado e calcule a área (lado * lado). 
...
// Exercício 04 - Área de Triângulo: Leia a base e a altura de um triângulo e calcule a área: (base * altura) / 2

double baset, altura;
Console.WriteLine("Insira a medida da base do triângulo:");
baset = Convert.ToDouble(Console.ReadLine());

Console.WriteLine("Insira a medida da altura do triângulo:");
...
// Exercício 05 - Constante – Área do Círculo Declare uma constante PI = 3.14159. Peça o raio de um círculo.
...
Console.WriteLine($"A área do círclo é: {resultado}");


// Exercício 06 - Perímetro do Retângulo Peça a largura e a altura de um retângulo e calcule o perímetro:
